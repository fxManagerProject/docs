            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Monitor svMain, svSync, and svNetwork threads instantly to
                  identify script bottlenecks before they affect player
                  experience.
                </p>
              </div>
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Compare current performance against session history to detect
                  gradual degradation or resource leaks over long uptimes.
                </p>
              </div>
            </div>
          </div>

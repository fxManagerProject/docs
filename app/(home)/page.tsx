    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] flex-1 px-4 py-12 select-none max-w-5xl mx-auto">
      <div className="text-center mb-16 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            href="/support"
            className="w-full sm:w-auto inline-flex h-11 items-center justify-center rounded-md border border-input bg-background px-8 font-medium shadow-sm transition-colors hover:bg-accent/70 hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-fd-ring"
          >
            Support the project
          </Link>
          <Link
            href="/docs"
            className="w-full sm:w-auto inline-flex h-11 items-center justify-center rounded-md bg-fd-primary px-8 font-medium text-fd-primary-foreground shadow transition-colors hover:bg-fd-primary/70 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-fd-ring"
          >
            View Docs
